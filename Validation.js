...
function validator_Religion() {
    if (document.getElementsByName("DDL_Religion").item(0).value == 0) {
        ...
        window.frames[0].getElementById("DDL_Religion").focus();
        //alert(document.getElementsByName("DDL_Religion").item(0).value.focus());
        document.getElementsBy('DDL_Religion').focus();
        return false;
    }
