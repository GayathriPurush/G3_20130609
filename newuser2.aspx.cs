...
public partial class newuser2 : System.Web.UI.Page
{
    ...
    {
        //Session["ProfileFor"] = DDl_ProfileFor.SelectedItem.Text;
        if(DDl_ProfileFor.SelectedItem.Text=="Myself")
        {
            Session["ProfileFor"]="M";
        }

        else if(DDl_ProfileFor.SelectedItem.Text=="Son")
        {
            Session["ProfileFor"]="S";
        }
        else if(DDl_ProfileFor.SelectedItem.Text=="Daughter")
        {
            Session["ProfileFor"]="D";
        }
        else  if(DDl_ProfileFor.SelectedItem.Text=="Brother")
        {
            Session["ProfileFor"]="B";
        }
        else if(DDl_ProfileFor.SelectedItem.Text=="Sister")
        {
            Session["ProfileFor"] = "S";
        }
        else if (DDl_ProfileFor.SelectedItem.Text == "Friend")
        {
            Session["ProfileFor"] = "F";
        }
        else if (DDl_ProfileFor.SelectedItem.Text == "Relative")
        {
            Session["ProfileFor"] = "R";
        }
